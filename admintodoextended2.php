...
<?php 
 ...
 $query1 = sprintf("select * from todo_{$val} where sno = $var");
...
message.style.top = contentnavbar.offsetHeight+"px";
   ...
   if(isset($_POST["dlt"]))
   {
    ...
    $queryinsert = sprintf("update todo_{$val}_personal set status = 'd' where sno = $var");
...
window.location.href ='admintodo.php'  ;
   ...
   if(isset($_POST["rec"]))
   {
    ...
    $queryinsert = sprintf("update todo_{$val}_personal set status = '' where sno = $var");
