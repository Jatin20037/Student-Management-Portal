...
<body>
<form method = "get" style = "color:silver;display:flex;height:50px;">
<div style = "width:100%;height:10rem;position:absolute;background:#292f45;" id = "contentnavbar">
<br><br>
<a href = "principaldashboard.php" style = "color:silver;font-family:'Poppins', sans-serif;font-size:min(2vw,3rem);font-weight:bold;margin-left:5%;"><span class = "glyphicon glyphicon-home">
</span></a>
...
<select style = "width:10%;border-radius:30px;background:none;font-size:min(1.5vw,2rem);float:right;margin-right:5%;visibility:hidden;" name = "classselector" id = "classselector">
<option> Class</option>
<option> I</option>
<option> II </option>
<option> III </option>
...
<button style = "background:none;border:none;font-size:min(1.5vw,2rem);float:right;visibility:hidden;" name = "classbt" id = "classbt"><span class = "glyphicon glyphicon-search"></span> </button>
</form>
<font style = "color:grey;font-family:'Poppins', sans-serif;font-size:min(2vw,2rem);font-weight:bold;padding:10px;background:#161d30;border-radius:5px;border:1px solid 7367f0;box-shadow: 0 0 15px 3px #7367f0;float:right;margin-right:3%;cursor:pointer;" id = "examcumplanner">Examination</font>
</form>
</div>
<form>
...
classbt.style.visibility = "hidden";
classselector.style.visibility = "hidden";
let text = document.getElementById("examcumplanner").innerHTML; 
...
{$class = $_GET["classselector"];
$query5 = sprintf("select * from {$class}_syllabus");
