...
<body>
   ...
   <a href = "admintodo.php"> <span class="glyphicon glyphicon-menu-left" style = "font-size:min(6vw,2rem);padding:2%;cursor:pointer;" id = "back"></span></a>
   ...
   <button class="glyphicon glyphicon-trash"style = "font-size:min(3.5vw,2rem);color:orangered;background:none;border:none;" id="trash" name = "trash"></button>
   </form>
  
    <div style = "width:90%;height:auto;margin:5%;background:#292f45;border-radius:7px;position:relative;" id = "message">
   
    <img src = "assets/student profiles/<?php echo $school; ?>/user.png" style = "border-radius:50%;width:5rem;max-width:15vw;margin-left:1.5%;margin-top:1.5%;">
...
message.style.top = contentnavbar.offsetHeight+"px";
  ...
  <?php
   ...
   if(isset($_POST["trash"]))
   {
    ...
    $queryinsert = sprintf("delete from  todo_{$val} where sno = $var");
     
     $connecttinsert = mysqli_query($con,$queryinsert);

$query1 = sprintf("select * from students");
...
$queryinsert2 = sprintf("delete from todo_{$dataa1[username]} where sno = $var");
     
$connecttinsert2 = mysqli_query($con,$queryinsert2);
     
 } 
 echo "<script>
window.location.href ='admintodo.php'  ;
</script>"; 
   }
